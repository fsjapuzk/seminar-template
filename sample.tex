...
%\japterm{kanji}{漢字}{chin. Schriftzeichen}
...
\textbf{Beispiel}: Mustermann sagt hierzu: \enquote{Direkte Zitate ohne Fußnote und Quellenangabe sind wertlos.}%TODO quote footnote
...
\textbf{Beispiel}: Eine hiervon abweichende Praxis sieht Doe als Missachtung wissenschaftlicher Prinzipien an.%TODO quote footnote
...
Beim erstmaligen Verweis auf eine Quelle in der Fußnote sind die \textbf{vollständigen Literaturangaben} aufzuführen. Beachten Sie hierfür unsere Vorgaben für die Notation! Bei allen weiteren Nennungen wird ein Kurzbeleg (Autor, (Kurz-)Titel und Seitenzahl) verwendet.%TODO footnote 4

\subsubsection{Japanische Quellen}
Bei Zitaten aus dem Japanischen muss der Originaltext nicht noch einmal wiedergegeben werden, die genaue Quellenangabe reicht hier aus. Bei japanischen Titeln werden Autor, Titel, Reihe und Zeitschriftentitel transliteriert und mit den entsprechenden \textit{kanji} versehen. Die \textit{kanji} der Buchtitel werden \textbf{nicht} kursiv gesetzt! Eine Übersetzung des Titels ist in der Regel nicht nötig, es sei denn, im Fließtext wird explizit darauf Bezug genommen. Verlagsort und Verlag können ohne Angabe der \textit{kanji} lediglich transliteriert werden.%TODO footnote 5

%Testverlag 2014, S. 12.
%3 Vgl. DOE, Jane: Get Your References Straight! Why Footnotes Matter. Springfield: Corny Publishing 2013, S.
%13f. 4 Vgl. MUSTERMANN: Der Sinn von Quellenangaben, S. 10. 5 Vgl. SUZUKI, Kazuko 鈴木和子: Ronbun wo kakimashô! 論文を書きましょう！ Kyôto: Muromachi shoten
%2011, S. 112.
